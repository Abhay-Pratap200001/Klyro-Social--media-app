...
function ProfilePageClient({isFollowing:intialFollowing, likedPosts, posts, user}:ProfilePageClientProps) {
            ...
            <div className="space-y-6">
              {posts.length > 0 ? (
                posts.map((post, index) => (
                  <PostCard key={post.id} post={post} dbUserId={user.id} index={index} />
                ))
              ) : (
